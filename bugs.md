...
All Critical, Moderate, and Minor findings are **fixed as of 1.5.1** (build verified with Maven).
...
**1.5.1 Minor closure:** the LOD and custom-AI zombie scans now share one pass; class behavior config
