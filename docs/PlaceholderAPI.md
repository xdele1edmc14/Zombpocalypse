...
xApocalypse 1.6.0 provides an internal [PlaceholderAPI](https://www.spigotmc.org/resources/placeholderapi.6245/) expansion. PlaceholderAPI is optional: xApocalypse loads normally without it, and automatically registers the expansion when it is installed.
